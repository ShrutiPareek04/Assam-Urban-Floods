# third model - ARIMA
# to compare the time series flood's performance and better capture the impact of other variables, we consider GLM
# GLM allows us to explore a variety of underlying distributions. 
# Given the count nature of the output variable, we consider normal, poisson, quasi poisson and negative binomial distribution.
