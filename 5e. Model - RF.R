...
# to allow for capturing more complex non-linear relationships
# to allow for extraction of a rule-based structure (XAI point of view) we introduce a random forest
# script also contains XAI techniques applied on RF
# custom code development - to extract rules from RF
