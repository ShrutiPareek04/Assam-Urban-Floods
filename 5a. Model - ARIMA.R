# first model - ARIMA
# given the data collected is from 2000-24, it is essential to capture the temporal dynamics of flood count.
# thus, we begin the modelling with a univariate time series model - ARIMA.
...
# 4. ETS Model (exploration - not used in the study)
ets_model <- ets(df_ts)
summary(ets_model)
