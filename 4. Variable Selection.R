# Feature Selection
# before a predictive model is built, we must select the variables which are parsimonious i.e. statistically significant
# i.e. capture the underlying variation in our data very well. 
# to do this, we use Lasso Regression and Random forest to compare and assess the most important variables.
