# second model - ARIMAX
# ARIMA does not consider any exogenous variables - which can contain valuable insights about the development of floods
# thus, ARIMAX model is considered to bring in the impact of other variables.

# note: the best ARIMAX structure found was similar to the ARIMA model, excluding all variables
# thus, in the code below, we amended to check of the best model but with containing other variables
